...
INSERT INTO `tbl_product` (
    ...
    -- 행사제품
    (1, '생수 세트', 2000, 'Y', 30, 1),
    (2, '컵라면 세트', 3000, 'Y', 30, 1),
    (3, '간식 묶음 세트', 5000, 'Y', 20, 1),
    (4, '도시락 음료 세트', 6500, 'Y', 20, 1),
    (5, '여행용 생활용품 세트', 8000, 'Y', 15, 1),
    -- 라면류
    (6, '신라면', 1000, 'Y', 100, 2),
    (7, '진라면 매운맛', 950, 'Y', 90, 2),
    (8, '너구리', 1100, 'Y', 80, 2),
    (9, '짜파게티', 1200, 'Y', 70, 2),
    (10, '육개장 사발면', 1300, 'Y', 60, 2),
    -- 과자류
    (11, '새우깡', 1500, 'Y', 80, 3),
    (12, '포카칩', 1700, 'Y', 70, 3),
    (13, '초코파이', 4800, 'Y', 50, 3),
    ...
    (15, '홈런볼', 2000, 'Y', 40, 3),
    -- 간편식품
    (16, '참치 삼각김밥', 1200, 'Y', 50, 4),
    (17, '전주비빔 삼각김밥', 1300, 'Y', 45, 4),
    (18, '제육 도시락', 5500, 'Y', 30, 4),
    (19, '김치볶음밥', 4500, 'Y', 25, 4),
    (20, '핫바', 2000, 'Y', 40, 4),
    -- 신선제품
    (21, '바나나', 2000, 'Y', 20, 5),
    (22, '사과', 1500, 'Y', 20, 5),
    (23, '샐러드', 4500, 'Y', 15, 5),
    (24, '구운계란 2입', 1800, 'Y', 30, 5),
    (25, '딸기컵', 3500, 'Y', 15, 5),
    -- 음료
    (26, '생수 500ml', 1000, 'Y', 200, 6),
    (27, '콜라 500ml', 2000, 'Y', 100, 6),
    (28, '사이다 500ml', 2000, 'Y', 90, 6),
    (29, '오렌지주스', 2500, 'Y', 60, 6),
    (30, '아메리카노', 1800, 'Y', 70, 6),
    -- 아이스크림
    (31, '초코 아이스크림', 1800, 'Y', 60, 7),
    (32, '바닐라콘', 2000, 'Y', 50, 7),
    (33, '메로나', 1200, 'Y', 80, 7),
    (34, '월드콘', 2200, 'Y', 45, 7),
    (35, '아이스컵', 1000, 'Y', 100, 7),
    -- 생활용품
    (36, '물티슈', 3000, 'Y', 40, 8),
    (37, '칫솔', 2500, 'Y', 35, 8),
    (38, '치약', 3500, 'Y', 30, 8),
    ...
    (41, '캔맥주', 3500, 'Y', 50, 9),
    (42, '소주', 2000, 'Y', 60, 9),
    (43, '발렌타인10년', 50000, 'Y', 30, 9),
    (44, '막걸리', 1500, 'Y', 15, 9),
    (45, '발렌타인30년', 200000, 'Y', 25, 9),
    -- 담배
    (46, '담배 A', 4500, 'Y', 40, 10),
    (47, '담배 B', 4500, 'Y', 35, 10),
    (48, '담배 C', 4500, 'Y', 30, 10),
    (49, '담배 D', 4500, 'Y', 25, 10),
    (50, '품절 담배 테스트', 4500, 'N', 0, 10)
ON DUPLICATE KEY UPDATE
