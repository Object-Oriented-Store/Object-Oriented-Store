...
회원가입과 로그인부터 상품 조회, 주문, 행사 할인, 결제, 포인트 적립 및 결제 취소까지 편의점 구매의 주요 흐름을 구현했습니다.
...
| Member | 회원 계정, 보유 포인트 및 누적 구매금액 관리 |
...
| `02_insert_seed_data.sql` | 회원등급과 카테고리 기본 데이터 등록 |
| `03_insert_test_data.sql` | 개발용 회원, 상품, 행사 및 주문 데이터 등록 |
...
| 구분 | 아이디 | 비밀번호 |
|---|---|---|
| BASIC 회원 | `basic_member` | `test1234` |
| GOLD 회원 | `gold_member` | `test1234` |
| VIP 회원 | `vip_member` | `test1234` |
| 관리자 | `admin` | `admin1234` |
